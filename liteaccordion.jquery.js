...
;(function($) {
    ...
    var LiteAccordion = function(elem, options) {
        ...
        // 'globals'
            ...
            slideWidth = function(){
                return accord.width() - slideLen * settings.headerWidth;
            }
                ...
                setSlidePositions : function() {
                    ...
                    header.each(function(index) {
                        var $this = $(this),
                            right = index == 0 ?
                                "unset" : 
                                -(settings.containerHeight - settings.headerWidth) + ((slideLen - index-1) * settings.headerWidth),
                            slideRight = index == 0 ?
                                "unset":
                                -slideWidth() - ((index +1) * settings.headerWidth),
                        ...
                        $this
                            ...
                            // .next()
                                //.width(slideWidth()
                                //.css({ right : slideRight, paddingLeft : settings.headerWidth });
                ...
                animSlide : function(triggerTab) {
                    ...
                    if (!!this.index) {
                        this.elem
                            ...
                            .stop(true)
                            .animate({
                                // right : this.pos - (this.index) * settings.headerWidth
                            },
                                settings.slideSpeed,
                                settings.easing,
                                function() {
